...
Settings:
  ...
  sectionHeadings: [
    {label: "Core Settings", value: "Paramètres principaux"}
    {label: "Editor Settings", value: "Paramètres de l'éditeur"}
    {label: "System Settings", value: "Paramètres système"}
    {label: "Keybindings", value: "Raccourcis clavier"}
    ...
    {label: "Featured Themes", value: "Thèmes à la une"}
  ]
  subSectionHeadings: [
    {label: "Invisible", value: "Invisible"}
    {label: "Community Packages", value: "Packages créés par la communauté"}
    {label: "Core Packages", value: "Packages principaux"}
    {label: "Development Packages", value: "Packages de développement"}
    {label: "Git Packages", value: "Packages Git"}
    {label: "Community Themes", value: "Thèmes créés par la communauté"}
    {label: "Core Themes", value: "Thèmes principaux"}
    {label: "Development Themes", value: "Thèmes de développement"}
    {label: "Git Themes", value: "Thèmes Git"}
  ]
  settings: {
    notes: [
      {
        id: 'core-settings-note'
        html: 'Ce panel comprend les paramètres principaux d\'Atom, sans lien avec l\'éditeur de texte. Certains packages
               peuvent avoir leurs propres paramètres. Pour plus d\'informations, consultez les pages individuelles de chaque package disponibles dans la <a class="link packages-open">liste des packages</a>.'
      }
      {
        id: 'editor-settings-note'
        html: 'Ce panel comprend les paramètres de l\'éditeur de texte. Il se peut que certains de ces paramètres ne s\'appliquent pas comme prévu pour certains langages.
               Pour plus d\'informations, consultez les pages individuelles de chaque package de langage dans la <a class="link packages-open">liste des packages</a>.'
      }
    ]
    controls: [
      {
        ...
        desc: "Permets de prévisualiser le contenu de fichiers sans avoir à les ajouter à un volet de manière permanente.
        Par exemple, lorsqu'un seul clic est effectué sur un fichier depuis la colonne de navigation à gauche, ce fichier
        est considéré comme étant « provisoire » et sera remplacé par le prochain fichier provisoire ouvert. Cela peut s'avérer utile lorsque vous voulez, par exemple, rechercher une information mais que vous ne vous souvenez
        plus du fichier dans lequel cette information se trouve : vous pouvez donc ouvrir plusieurs fichiers sans avoir à tous
        les fermer une fois l'information trouvée. Plus d'informations (en anglais) sont disponibles sur http://flight-manual.atom.io/, chapitre 2, section « Pending Pane Items »."
      }
      {
        id: 'core.audioBeep'
        title: "Signal sonore"
      ...
      }
      {
        ...
        desc: "Les fichiers et dossiers ignorés par le système VCS (Gestion de versions) du projet actuel seront aussi ignorés par certains packages,
               tels que Fuzzy Finder et Find and Replace. Par exemple, les projets utilisant Git définissent ces chemins dans le fichier .gitignore.
               Certains packages peuvent avoir leurs propres paramètres concernant l'exclusion des fichiers et dossiers ignorés par VCS."
      }
      {
      ...
      }
      {
        ...
        desc: "Liste des motifs glob. Les fichiers et les répertoires correspondant à ces motifs seront ignorés par certains packages,
               tels que Fuzzy Finder et Tree View (colonne de navigation à droite)
               Certains packages peuvent avoir leurs propres paramètres concernant les extensions ignorées."
      }
      {
      ...
      }
      {
        ...
        desc: "Si l'option « Type de tabulations » est définie sur « auto » et que la détection automatique du type de tabulations échoue, alors ce paramètre sera utilisé à la place.
      ...
      }
      {
        ...
        desc: "Un retour à la ligne sera automatiquement effectué si les lignes dépassent la largeur de la fenêtre. Si l'option « Retour à la ligne automatique à une longueur de ligne spécifique » est activée,
        un retour à la ligne sera effectué au nombre de caractères défini par l'option « Longueur de ligne spécifique »."
      }
      {
        id: 'editor.softWrapAtPreferredLineLength'
        title: "Retour à la ligne automatique à une longueur de ligne spécifique"
        desc: "Au lieu d'effectuer un retour à la ligne si la largeur de la fenêtre est dépassé, activer cette option effectuera un retour à la ligne au nombre de caractères défini par l'option « Longueur de ligne spécifique ».
        Cela ne prendra effet que si l'option « Tabulations soft » est activée pour tous les langages ou pour le langage actuellement utilisé.
        Remarque : si vous souhaitez cacher l'indication de retour à la ligne (la ligne verticale), vous pouvez désactiver le package wrap-guide."
      }
      {
      ...
      }
      {
        ...
        desc: 'Détermine le caractère à insérer lorsque la touche Tab est appuyée. Valeurs possibles : « auto », « soft » et « hard ».
        Lorsque la valeur est définie sur « soft » ou « hard », les tabulations soft (espaces) ou les tabulations hard (caractères de tabulation)
        sont utilisées selon l\'option choisie. Lorsque la valeur est définie sur « auto », l\'éditeur se chargera de détecter automatiquement
        le type de tabulations à utiliser en se basant sur les contenus du buffer, ou utilisera la valeur « soft » si la détection automatique échoue.'
      }
      {
        id: 'editor.undoGroupingInterval'
        title: "Intervalle d'application des annulations"
        desc: "L'intervalle de temps en millisecondes pendant laquelle les opérations d'édition de texte sont « groupées » dans l'historique des annulations.
        Par exemple, si l'intervalle est de 10 000 millisecondes, appuyer simultanément sur CTRL et Z annulera les modifications effectuées toutes les 10 secondes.
        La même option s'applique pour l'action « Rétablir » (CTRL+Y)."
      }
      {
