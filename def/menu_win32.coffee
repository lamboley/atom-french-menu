      ...
      "Reopen Project":
        ...
        submenu:
          "Clear Project History":
            value: "Effacer l'historique des projets"
      "Reopen Last &Item":
  ...
  "&Edit":
    ...
    submenu:
      ...
      "Paste Without Reformatting":
        value: "Coller sans reformater"
      "Select &All":
        value: "Sélectionner tout (&A)"
      "&Toggle Comments":
      ...
      Lines:
        ...
        submenu:
          ...
          "&Join Lines":
            value: "Joindre les lignes sélectionnées (&J)"
      Columns:
        value: "Colonnes"
        submenu:
          "Move Selection &Left":
  ...
  "&Selection":
    ...
    submenu:
      ...
      "Select to Beginning of L&ine":
        value: "Sélectionner jusqu'au début du mot (&I)"
